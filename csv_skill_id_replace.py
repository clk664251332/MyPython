...
CSV_CONFIG = [
    ...
    ["ProfessionTable", ["SkillIds","RootTransfromSkills","FixedSkillIds","FixedUnlockSkillIds","FixedCommonSkillIds"], [replace_all, replace_all, replace_id_iv], [None, None, [0,1]]],
